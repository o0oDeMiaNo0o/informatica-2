...
public class Login extends JFrame {
	...
	public Login() {
		...
		transparentPanel.add(lblUsuario, "cell 1 1,alignx left,aligny center");
		...
		transparentPanel.add(lblContrasea, "cell 1 2,alignx left,aligny center");
		...
		transparentPanel.add(btnIngresar, "cell 2 3,alignx right");
