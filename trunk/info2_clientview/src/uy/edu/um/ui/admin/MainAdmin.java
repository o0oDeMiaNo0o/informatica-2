...
public class MainAdmin extends BasicoAdmin {
	...
	public MainAdmin() {
		...
		JLabel lblBienvenidoAlPanel = new JLabel("Bienvenido Al Panel De Administraci\u00F3n");
		...
		transparentPanel.add(lblNewLabel, "cell 1 3,alignx center,aligny center");
		...
		contentPane.add(transparentPanel_1, BorderLayout.NORTH);
				...
				transparentPanel_1.add(imagePanel, "cell 0 0,alignx center,aligny center");
	}
